...
module.exports = Waline({
  ...
  async preSave(comment) { // 在保存评论数据前
    ...
    comment.comment = comment.comment.replace(/<img class="wl-emoji" src="\/images\/emote\/(.+)" alt="([^.]+)(?:\.(?:gif|png))?">/, '<img class="wl-emoji" src="/images/emote/$1" alt="[$2]">'); // 去除表情的替代文本的扩展名，添加中括号
  },
